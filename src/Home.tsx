...
const verses = [
  ...
  { first: "وَهْوَ الَّذِي أَدْخَلَهَا فِي حِرْزِهِ", second: "فَلَزِمَ الْقُرَّا لُزُومَ غَرْزِهِ" },
  { first: "وَذَاكَ لِلْقَاضِي الرِّضَى الْمُعَاصِرِ", second: "كُشَاجِمِ الْعَصْرِ الْإِمَامِ النَّاصِرِي" },
  { first: 'سَلَّمَهَا فَاظْفَرْ بِمَا "اِلدَّاهُ"', second: "سَطَّرَهُ فَحَقَّهُ أَدَّاهُ" },
  { first: "وَعَنْ طَوِيلِ الشَّاطِبِيِّ عَدَلَا", second: "لِرَجَزٍ يَكُونُ عَنْهُ بَدَلَا" },
  { first: "وَهْوَ لِغُصْنِ حِرْزِهِ قَدِ اهْتَصَرْ", second: "لَكِنَّهُ أَوْجَزَ فِيهِ وَاخْتَصَرْ" },
  { first: "مُقَرِّبًا لَهُ بِحِلْيَةِ النَّوَا", second: "دِي آخِذًا جَنَاهُ مِنْ دُونِ النَّوَى" },
  { first: "فَلَيْسَ فِيهَا بِالْحُرُوفِ رَمْزُ", second: "وَالرَّمْزُ عِنْدِي لَيْسَ فِيهِ لَمْزُ" },
  { first: "إِذْ نَفْعُهُ مَضَتْ بِهِ قُرُونُ", second: "لَكِنَّمَا الْمَنْهَجُ مَنْجَنُونُ" },
  ...
  { first: "وَهْوَ عَلَى طَرِيقِهَا عَلَامَهْ", second: "وَاللَّامُ إِنْ تُشَدَّدْ فَلَا مَلَامَهْ" },
  { first: "فَهْوَ ابْنُ إِسْحَاقَ بِهَا وَالْبَاجِي", second: "وَابْنُ دَقِيقِ الْعِيدِ وَابْنُ الْحَاجِ" },
  { first: "وَهْوَ جَلَالُ الدِّينِ فِي الْمَعَانِي", second: "عِلْمًا وَفِي الْبَدِيعِ وَالْبَيَانِ" },
  { first: "وَهْوَ الْكِسَائِيُّ وَعَمْرٌو وَالْفَرَا", second: "هِيدِي وَكُلُّ الصَّيْدِ فِي جَوْفِ الْفَرَا" },
